...
>>>>>>> 7b172d997c0f581332306c4fe724ea1378fa7a15
        ...
        return view('peserta/v_peserta', $data);
    }
    ...
    public function detail_siswa($nisn)
    {
        ...
        return view('peserta/v_detail_siswa', $data);
    }
...
>>>>>>> 7b172d997c0f581332306c4fe724ea1378fa7a15
        ...
        session()->setFlashdata('pesan', 'Peserta Didik Berhasil Di Luluskan!!!');
        return redirect()->to(base_url('peserta'));
    }
    ...
    public function keluar($nisn)
    {
        ...
        $this->ModelPeserta->edit($data);
        session()->setFlashdata('pesan', 'Peserta Didik Berhasil Dikeluarkan !!!');
        return redirect()->to(base_url('peserta'));
    }
    ...
    public function eksporpdf()
    {
        ...
        $html = view('peserta/eksporpdf', $data);
        $dompdf->loadHtml($html);
    ...
    public function updateakte($nisn)
    {
        if ($this->validate([

            'akte' => [
                'label' => 'Foto',
                'rules' => 'max_size[akte,1024]|mime_in[akte,image/png,image/jpg,image/gif,image/jpeg,image/ico]',
                'errors' => [
                    'max_size' => '{field} Max 1024 KB !!!!',
                    'mime_in' => 'Format {field} Harus PNG, JPG, JPEG, GIF, ICO !!!!',
                    'max_size' => 'Harus Size 1024Kb'
            ...
            //masukan foto ke input
            $foto = $this->request->getFile('akte');
            if ($foto->getError() == 4) {
    ...
    // CONTROLLER PESERTA SAMPAI DISINI
    ...
    public function sudahlulus()
    {
        ...
        $data = [
            ...
            'submenu'    => 'sudahlulus',
            'tingkat'    => $this->ModelKelas->Tingkat(),
            'lulus'    => $this->ModelPeserta->sudahlulus(),
            'tahun'    => $this->ModelPeserta->tahundata()

            // 'siswa'    => $this->ModelPeserta->detail_data()

        ];
        return view('peserta/lulus', $data);
    }
    public function sudahkeluar()
    {
        ...
        $data = [
            ...
            'submenu'    => 'sudahkeluar',
            'tingkat'    => $this->ModelKelas->Tingkat(),
            'keluar' =>   $this->ModelPeserta->sudahkeluar(),


            // 'siswa'    => $this->ModelPeserta->detail_data()

        ];
        return view('peserta/keluar', $data);
    }

    public function printmohon($nisn)
    {
        $options = new Options();
        ...
        $data = [
            'keluar'         => $this->ModelPeserta->permohonan($nisn),
        ...
        $html = view('peserta/surat_pindah', $data);
        //Atur Gambar
        ...
        $dompdf->render();
        // $dompdf->stream();
        $dompdf->stream('surat mutasi.pdf', array(
            "Attachment" => false
        ));
        exit();
    }
    ...
    public function Lihatsiswa()
    {
        ...
        $data = [
            'datasiswa' => $this->ModelPeserta->DataPesertaLulus($ta),
        ];
        $response = [
            'data' => view('peserta/tabel_lulus',  $data)
        ];
