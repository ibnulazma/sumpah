                ...
                foreach ($pekerjaan as $key => $value) { ?>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#hapus<?= $value['id_pekerjaan'] ?>"><i class="fas fa-trash"></i></button>
...
<div class="modal fade" id="tambah" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <?php echo form_open('pekerjaan/add') ?>
...
<?php foreach ($pekerjaan as $key => $value) { ?>
    <div class="modal fade" id="hapus<?= $value['id_pekerjaan'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Apakah anda akan menghapus data <?= $value['pekerjaan'] ?> ini???</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary pull-left" data-dismiss="modal">Batal</button>
                    <a href="<?= base_url('pekerjaan/delete/' . $value['id_pekerjaan']) ?>" type="submit" class="btn btn-danger">Delete</a>
                </div>
            </div>
            <!-- <?php echo form_close() ?> -->
        </div>
